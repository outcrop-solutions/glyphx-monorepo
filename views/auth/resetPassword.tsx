...
export default function ResetPassword() {
  ...
  const handleSubmitCode = async () => {
    try {
      ...
      console.log({result})
      if(result === "SUCCESS"){ // if successfull navigate to sign in
  ...
  return (
    <div className="flex h-full items-center justify-center w-full scrollbar-none bg-secondary-midnight">
      ...
      <div className="flex flex-col justify-center px-4 py-8 w-96 min-h-56">
        <div className="rounded-md p-8 bg-secondary-space-blue border-gray border">
          {
            ...
            <div className="flex flex-row items-center justify-between">
                <p className="font-roboto font-normal text-[14px] leading-[16px] text-yellow cursor-pointer">Resend Code</p>
            <div>
              <button
          ...
          <Link href="/auth/signIn">
            <div className="flex flex-row items-center justify-center hover:cursor-pointer font-roboto font-medium text-[14px] leading-[16px] text-light-gray">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.71 15.88L10.83 12L14.71 8.11998C15.1 7.72998 15.1 7.09998 14.71 6.70998C14.32 6.31998 13.69 6.31998 13.3 6.70998L8.71 11.3C8.32 11.69 8.32 12.32 8.71 12.71L13.3 17.3C13.69 17.69 14.32 17.69 14.71 17.3C15.09 16.91 15.1 16.27 14.71 15.88Z" fill="#CECECE" />
              </svg>
        ...
        {errorMessage ? (
          <div className="btn font-roboto font-medium text-[14px] leading-[16px] bg-yellow text-white my-4 w-full">{errorMessage}</div>
        ) : null}
      </div>
