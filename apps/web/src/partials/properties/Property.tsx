...
import { AxisInterpolationAtom, AxisDirectionAtom } from "src/state/properties";
import { modelCreationLoadingAtom } from "src/state/globals";
...
export const Property = ({
  ...
  function change_LOG_LIN() {
    if (
      ...
      lastDroppedItem.dataType !== "string" &&
      !isCreatingModel
    ) {
      // if it is not a string then we can change default interpolation
  ...
  function clearPressed() {
    if (lastDroppedItem && !isCreatingModel) {
      // if last dropped is not null
      ClearProperty(axis);
    }
  }
    ...
    >
      ...
      >
        {!clearAxis ? (
          ...
          <div className="h-4" onClick={clearPressed}>
            <svg
              className={`${isCreatingModel ? "opacity-30" : "opacity-100"}`}
              width="16"
              height="16"
              viewBox="0 0 16 16"
              fill="none"
      ...
      >
        ...
        {swap ? (
          ...
          >
            <path
              d="M3.99559 7.90785L2.0973 9.68086C1.96757 9.80796 1.96757 10.005 2.0973 10.1321L3.99559 11.9051C4.20727 12.1084 4.576 11.9623 4.576 11.6826V10.5388H8.67984C9.0554 10.5388 9.36268 10.2528 9.36268 9.90328C9.36268 9.55376 9.0554 9.26779 8.67984 9.26779H4.576V8.13027C4.576 7.84431 4.20727 7.7045 3.99559 7.90785ZM13.9035 5.86794L12.0053 4.09494C11.7936 3.89158 11.4248 4.03774 11.4248 4.31736V5.45488H7.31417C6.93861 5.45488 6.63133 5.74085 6.63133 6.09036C6.63133 6.43988 6.93861 6.72585 7.31417 6.72585H11.418V7.86337C11.418 8.14934 11.7867 8.28915 11.9984 8.08579L13.8967 6.31278C14.0333 6.19204 14.0333 5.98869 13.9035 5.86794Z"
              fill="white"
            />
          </svg>
        ) : (
          ...
          >
            <path
              d="M3.99559 8.09215L2.0973 6.31914C1.96757 6.19204 1.96757 5.99504 2.0973 5.86794L3.99559 4.09494C4.20727 3.89158 4.576 4.03774 4.576 4.31736V5.46123H8.67984C9.0554 5.46123 9.36268 5.7472 9.36268 6.09672C9.36268 6.44624 9.0554 6.73221 8.67984 6.73221H4.576V7.86973C4.576 8.15569 4.20727 8.2955 3.99559 8.09215ZM13.9035 10.1321L12.0053 11.9051C11.7936 12.1084 11.4248 11.9623 11.4248 11.6826V10.5451H7.31417C6.93861 10.5451 6.63133 10.2592 6.63133 9.90964C6.63133 9.56012 6.93861 9.27415 7.31417 9.27415H11.418V8.13663C11.418 7.85066 11.7867 7.71085 11.9984 7.91421L13.8967 9.68722C14.0333 9.80796 14.0333 10.0113 13.9035 10.1321Z"
              fill="white"
            />
          </svg>
        )}
