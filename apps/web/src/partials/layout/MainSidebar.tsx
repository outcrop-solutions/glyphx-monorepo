...
export const MainSidebar = () => {
  ...
  return (
    <div
      id="sidebar"
      className={`hidden lg:flex flex-col border border-r-gray absolute  bg-secondary-space-blue left-0 top-0 lg:static lg:left-auto lg:top-auto h-screen scrollbar-none ${
        pathname === '/' ? 'w-64' : 'w-20'
      } shrink-0 p-4`}
    >
      <div className="">
              ...
              <li className={`px-3 py-1 rounded-full mb-0.5 last:mb-0 ${pathname === '/' && 'bg-transparent'}`}>
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-sm font-medium ml-3 lg:opacity-100 duration-200 text-white">My Projects</span>
                  </div>
                </div>
              </li>
              {/* Analytics */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('shared') && 'bg-primary-dark-blue'}`}>
                ...
                >
                  <div className="flex">
                    ...
                    <span className="text-sm font-medium ml-3 lg:opacity-100 duration-200 text-white">Shared</span>
                  </div>
                </div>
              </li>
              {/* Analytics */}
                  ...
                  <div className="flex">
                    <div className={`flex items-center justify-center h-6 w-6 ${selectedProject ? 'ml-1' : ''}`}>
                      <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                          d="M13.6422 1.73444L12.5611 0.427778C12.3511 0.163333 12.0322 0 11.6667 0H2.33333C1.96778 0 1.64889 0.163333 1.43111 0.427778L0.357778 1.73444C0.132222 1.99889 0 2.34889 0 2.72222V12.4444C0 13.3 0.7 14 1.55556 14H12.4444C13.3 14 14 13.3 14 12.4444V2.72222C14 2.34889 13.8678 1.99889 13.6422 1.73444ZM2.52 1.55556H11.48L12.11 2.31H1.89778L2.52 1.55556ZM1.55556 12.4444V3.88889H12.4444V12.4444H1.55556ZM8.12778 5.44444H5.87222V7.77778H3.88889L7 10.8889L10.1111 7.77778H8.12778V5.44444Z"
                          fill="white"
                        />
                      </svg>
                    </div>

                    <span className="text-sm font-medium ml-3 lg:opacity-100 duration-200 text-white">Archived</span>
                  </div>
                </div>
              </li>
              {/* Analytics */}
              ...
              >
                ...
                >
                  <div className="flex">
                    ...
                    <span className="text-sm font-medium ml-3 lg:opacity-100 duration-200 text-white">Trash</span>
                  </div>
                </a>
              </li>
            </ul>
