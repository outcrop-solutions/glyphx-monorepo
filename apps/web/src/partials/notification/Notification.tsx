      ...
      <div className="pt-4 pl-4 pr-4">
        <div className="flex flex-row items-center justify-between">
          <div className="flex flex-row items-center justify-between space-x-3">
            ...
            >
              <path
                d="M17.7658 16.1354L16.7455 15.0769V10.9744C16.7455 8.45538 15.4485 6.34667 13.1865 5.78872V5.23077C13.1865 4.54974 12.6566 4 12.0001 4C11.3437 4 10.8138 4.54974 10.8138 5.23077V5.78872C8.54391 6.34667 7.25474 8.44718 7.25474 10.9744V15.0769L6.23448 16.1354C5.73622 16.6523 6.08421 17.5385 6.78811 17.5385H17.2042C17.9161 17.5385 18.2641 16.6523 17.7658 16.1354ZM15.1637 15.8974H8.83654V10.9744C8.83654 8.93949 10.0308 7.28205 12.0001 7.28205C13.9695 7.28205 15.1637 8.93949 15.1637 10.9744V15.8974ZM12.0001 20C12.8701 20 13.5819 19.2615 13.5819 18.359H10.4183C10.4183 19.2615 11.1222 20 12.0001 20Z"
                fill="white"
              />
            </svg>
            <p className="font-roboto font-medium text-light-gray text-[14px] leading-[16px]">Notifications</p>
          </div>
        ...
        <div className="mt-4 border-t-[1px] border-t-gray">
          <p className="font-roboto font-normal text-[10px] leading-[12px] text-gray mt-2">
            ...
            {new Date(selectedProject.createdAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
          </p>
          <div className="flex flex-row mt-2">
            ...
            <p className="font-roboto font-bold text-[12px] leading-[14px] text-light-gray">
              {selectedProject.author} <span className="font-normal">created the project</span>.
            </p>
          </div>
        </div>
      </div>
