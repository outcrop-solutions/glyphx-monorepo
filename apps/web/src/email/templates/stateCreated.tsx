...
export const StateCreatedTemplate = ({stateName, stateImage}: emailTypes.iStateCreatedData) => (
  <body className="bg-secondary-deep-blue h-screen w-screen flex flex-col justify-center items-center space-y-2">
    <div className="flex flex-col justify-center items-center w-60">
      <div className="text-white mb-2">A State was created in your project</div>
