...
export function TextEditor() {
  return <ClientSideSuspense fallback={<DocumentSpinner />}>{() => <Editor />}</ClientSideSuspense>;
}
...
function TiptapEditor({doc, provider}: EditorProps) {
  ...
  return (
    <div className={styles.container}>
      {canWrite ? <div className={styles.editorHeader}>{editor ? <Toolbar editor={editor} /> : null}</div> : null}
