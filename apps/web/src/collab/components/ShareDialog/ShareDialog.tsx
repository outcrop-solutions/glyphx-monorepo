...
export function ShareDialog({children, ...props}: Props) {
  ...
  } = useDocumentsFunctionSWR([clientDoc.getDocumentUsers, {documentId}], {
    refreshInterval: 0,
  });
  ...
  } = useDocumentsFunctionSWR([clientDoc.getDocumentGroups, {documentId}], {
    refreshInterval: 0,
  });
  ...
  } = useDocumentsFunctionSWR([clientDoc.getDocument, {documentId}], {
    refreshInterval: 0,
  });
