  ...
  return (
    ...
    >
      ...
      <div className="mr-1">
        {ishover ? (
          <svg
            className=" h-5 w-5 rounded-full border border-transparent hover:border-white"
            width="16"
            height="16"
            viewBox="0 0 16 16"
            fill="none"
      ...
      {ishover ? (
        <svg
          className=" h-5 w-5 mr-1 rounded-full border border-transparent hover:border-white"
          width="16"
          height="16"
          viewBox="0 0 16 16"
          fill="none"
