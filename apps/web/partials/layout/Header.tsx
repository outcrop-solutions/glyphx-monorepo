...
export const Header = () => {
  ...
  return (
    <div
      className={`sticky flex justify-between items-center bg-secondary-space-blue border-l border-b border-gray h-14 w-full pt-2 pb-2 ${
      ...
      <div className="px-4 sm:px-6 lg:px-0 lg:w-full">
        <div className={`flex items-center ${selectedProject ? 'justify-end' : 'justify-between'} h-16`}>
          ...
          <div className="flex justify-end items-center space-x-2">
            ...
            {selectedProject && <DropdownNotifications align="right" />}
