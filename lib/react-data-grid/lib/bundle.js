...
function useGridDimensions() {
  ...
  useLayoutEffect(() => {
    ...
    const resizeObserver = new ResizeObserver(entries => {
      if (entries[0].contentBoxSize && entries[0].contentBoxSize.length > 0) {
...
var css_248z$a = ".h1tr5c9i700-beta13{cursor:pointer;display:flex}.h1tr5c9i700-beta13:focus{outline:none}.h19r0msv700-beta13{grow:1;overflow:hidden;overflow:clip;text-overflow:ellipsis}";
...
function EditCell({
  ...
  useEffect(() => {
    ...
    window.addEventListener('mousedown', onWindowCaptureMouseDown, {
      capture: true
    });
    return () => {
      window.removeEventListener('mousedown', onWindowCaptureMouseDown, {
        capture: true
      });
      cancelFrameRequest();
    };
...
const textEditor = "t16y9g8l700-beta13";
