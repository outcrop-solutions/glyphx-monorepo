...
import {getProjectTemplate, createProjectTemplate, updateProjectTemplate, deleteProjectTemplate } from 'lib/server/projectTemplate';

const projectTemplate = async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  switch (req.method) {
    case webTypes.constants.HTTP_METHOD.GET:
      return getProjectTemplate(req, res);
    case webTypes.constants.HTTP_METHOD.POST:
      return createProjectTemplate(req, res);
