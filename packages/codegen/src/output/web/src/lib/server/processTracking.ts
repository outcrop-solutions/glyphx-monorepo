...
export const createProcessTracking = async (
  req: NextApiRequest,
  res: NextApiResponse
) => {
  try {
    const processTracking = await processTrackingService.createProcessTracking(
      req.body
    );
...
export const getProcessTrackings = async (
  req: NextApiRequest,
  res: NextApiResponse
) => {
  try {
...
export const updateProcessTracking = async (
  req: NextApiRequest,
  res: NextApiResponse,
  session: Session
) => {
...
export const deleteProcessTracking = async (
  req: NextApiRequest,
  res: NextApiResponse,
  session: Session
) => {
  ...
  try {
    if (ALLOW_DELETE) {
      await processTrackingService.deleteModelProcessTracking(
        processTrackingId as string
      );
    }
