 ...
 * @returns
 */
export const _createModelConfig = (modelConfig: databaseTypes.IModelConfig): webTypes.IFetchConfig => {
  return {
 ...
 * @returns
 */
export const _updateModelConfig = (id: string, dirtyModelConfig: databaseTypes.IModelConfig): webTypes.IFetchConfig => {
