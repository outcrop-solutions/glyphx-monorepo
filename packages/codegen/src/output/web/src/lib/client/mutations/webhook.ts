 ...
 * @returns
 */
export const _createWebhook = (webhook: databaseTypes.IWebhook): webTypes.IFetchConfig => {
  return {
 ...
 * @returns
 */
export const _updateWebhook = (id: string, dirtyWebhook: databaseTypes.IWebhook): webTypes.IFetchConfig => {
