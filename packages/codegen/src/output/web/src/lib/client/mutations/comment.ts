 ...
 * @returns
 */
export const _createComment = (comment: databaseTypes.IComment): webTypes.IFetchConfig => {
  return {
 ...
 * @returns
 */
export const _updateComment = (id: string, dirtyComment: databaseTypes.IComment): webTypes.IFetchConfig => {
