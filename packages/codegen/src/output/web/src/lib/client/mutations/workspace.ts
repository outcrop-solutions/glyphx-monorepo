 ...
 * @returns
 */
export const _createWorkspace = (workspace: databaseTypes.IWorkspace): webTypes.IFetchConfig => {
  return {
 ...
 * @returns
 */
export const _updateWorkspace = (id: string, dirtyWorkspace: databaseTypes.IWorkspace): webTypes.IFetchConfig => {
