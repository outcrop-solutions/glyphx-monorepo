...
const cleanVerificationToken = (verificationToken: databaseTypes.IVerificationToken) => {
 ...
 * @returns
 */
export const _createVerificationToken = (verificationToken: databaseTypes.IVerificationToken): webTypes.IFetchConfig => {
  return {
 ...
 * @returns
 */
export const _updateVerificationToken = (id: string, dirtyVerificationToken: databaseTypes.IVerificationToken): webTypes.IFetchConfig => {
