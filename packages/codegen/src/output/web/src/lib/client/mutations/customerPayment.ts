...
const cleanCustomerPayment = (customerPayment: databaseTypes.ICustomerPayment) => {
 ...
 * @returns
 */
export const _createCustomerPayment = (customerPayment: databaseTypes.ICustomerPayment): webTypes.IFetchConfig => {
  return {
 ...
 * @returns
 */
export const _updateCustomerPayment = (id: string, dirtyCustomerPayment: databaseTypes.ICustomerPayment): webTypes.IFetchConfig => {
