 ...
 * @returns
 */
export const _createProject = (project: databaseTypes.IProject): webTypes.IFetchConfig => {
  return {
 ...
 * @returns
 */
export const _updateProject = (id: string, dirtyProject: databaseTypes.IProject): webTypes.IFetchConfig => {
