 ...
 * @returns
 */
export const _createState = (state: databaseTypes.IState): webTypes.IFetchConfig => {
  return {
 ...
 * @returns
 */
export const _updateState = (id: string, dirtyState: databaseTypes.IState): webTypes.IFetchConfig => {
