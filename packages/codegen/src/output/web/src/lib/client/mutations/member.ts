 ...
 * @returns
 */
export const _createMember = (member: databaseTypes.IMember): webTypes.IFetchConfig => {
  return {
 ...
 * @returns
 */
export const _updateMember = (id: string, dirtyMember: databaseTypes.IMember): webTypes.IFetchConfig => {
