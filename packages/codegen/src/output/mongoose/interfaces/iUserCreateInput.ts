...
export interface IUserCreateInput
  extends Omit<databaseTypes.IUser, '_id' | 'createdAt' | 'updatedAt'  | 'accounts' | 'sessions' | 'membership' | 'invitedMembers' | 'createdWorkspaces' | 'projects' | 'customerPayment' | 'webhooks'> {
