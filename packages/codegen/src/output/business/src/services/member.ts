...
export class MemberService {
  public static async getMember(
    ...
    try {
      ...
      const member =
        await mongoDbConnection.models.MemberModel.getMemberById(id);
      return member;
    } catch (err: any) {
  ...
  public static async getMembers(
    ...
    try {
      const members =
        await mongoDbConnection.models.MemberModel.queryMembers(filter);
  ...
  public static async createMember(
    ...
    try {
      // create member
      const member =
        await mongoDbConnection.models.MemberModel.createMember(data);
