...
export class ModelConfigService {
  ...
  public static async getModelConfigs(
    ...
    try {
      const modelConfigs =
        await mongoDbConnection.models.ModelConfigModel.queryModelConfigs(filter);
    ...
    try {
      const id =
        modelConfigId instanceof mongooseTypes.ObjectId
          ...
          : new mongooseTypes.ObjectId(modelConfigId);
      const modelConfig =
        await mongoDbConnection.models.ModelConfigModel.updateModelConfigById(id, {
          ...data
        });
      return modelConfig;
    } catch (err: any) {
