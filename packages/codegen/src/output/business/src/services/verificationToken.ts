  ...
  public static async getVerificationToken(
    ...
    try {
      ...
      const verificationToken =
        await mongoDbConnection.models.VerificationTokenModel.getVerificationTokenById(id);
  ...
  public static async getVerificationTokens(
    ...
    try {
      const verificationTokens =
        await mongoDbConnection.models.VerificationTokenModel.queryVerificationTokens(filter);
    ...
    try {
      const id =
        verificationTokenId instanceof mongooseTypes.ObjectId
          ...
          : new mongooseTypes.ObjectId(verificationTokenId);
      const verificationToken =
        await mongoDbConnection.models.VerificationTokenModel.updateVerificationTokenById(id, {
          ...data
        });
      return verificationToken;
    } catch (err: any) {
