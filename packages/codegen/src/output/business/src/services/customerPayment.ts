  ...
  public static async getCustomerPayment(
    ...
    try {
      ...
      const customerPayment =
        await mongoDbConnection.models.CustomerPaymentModel.getCustomerPaymentById(id);
  ...
  public static async getCustomerPayments(
    ...
    try {
      const customerPayments =
        await mongoDbConnection.models.CustomerPaymentModel.queryCustomerPayments(filter);
    ...
    try {
      const id =
        customerPaymentId instanceof mongooseTypes.ObjectId
          ...
          : new mongooseTypes.ObjectId(customerPaymentId);
      const customerPayment =
        await mongoDbConnection.models.CustomerPaymentModel.updateCustomerPaymentById(id, {
          ...data
        });
      return customerPayment;
    } catch (err: any) {
...
public static async addCustomer(
    ...
    try {
      ...
      const updatedCustomerPayment =
        await mongoDbConnection.models.CustomerPaymentModel.addCustomer(id, user);
