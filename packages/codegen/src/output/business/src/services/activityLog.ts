...
export class ActivityLogService {
  ...
  public static async getActivityLogs(
    ...
    try {
      const activityLogs =
        await mongoDbConnection.models.ActivityLogModel.queryActivityLogs(filter);
    ...
    try {
      const id =
        activityLogId instanceof mongooseTypes.ObjectId
          ...
          : new mongooseTypes.ObjectId(activityLogId);
      const activityLog =
        await mongoDbConnection.models.ActivityLogModel.updateActivityLogById(id, {
          ...data
        });
      return activityLog;
    } catch (err: any) {
    ...
    try {
      const id =
        activityLogId instanceof mongooseTypes.ObjectId
          ...
          : new mongooseTypes.ObjectId(activityLogId);
      const updatedActivityLog =
        await mongoDbConnection.models.ActivityLogModel.addWorkspace(id, workspace);
    ...
    try {
      const id =
        activityLogId instanceof mongooseTypes.ObjectId
          ...
          : new mongooseTypes.ObjectId(activityLogId);
      const updatedActivityLog =
        await mongoDbConnection.models.ActivityLogModel.addUserAgent(id, userAgent);
    ...
    try {
      const id =
         activityLogId instanceof mongooseTypes.ObjectId
          ...
          : new mongooseTypes.ObjectId( activityLogId);
      const updatedActivityLog =
        await mongoDbConnection.models.UserAgentModel.removeUserAgent(id, userAgent);
