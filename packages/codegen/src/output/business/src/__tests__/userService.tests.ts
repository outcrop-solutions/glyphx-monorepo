...
describe('#services/user', () => {
  ...
  context('createUser', () => {
    it('will create a User', async () => {
      ...
      const accountsId = new mongooseTypes.ObjectId();
      const sessionsId = new mongooseTypes.ObjectId();
      const membershipId = new mongooseTypes.ObjectId();
      const createdWorkspacesId = new mongooseTypes.ObjectId();
      const projectsId = new mongooseTypes.ObjectId();
      const customerPaymentId = new mongooseTypes.ObjectId();
      const webhooksId = new mongooseTypes.ObjectId();
