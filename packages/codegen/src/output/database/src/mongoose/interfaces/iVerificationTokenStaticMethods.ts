...
export interface IVerificationTokenStaticMethods
  ...
  updateVerificationTokenWithFilter(filter: Record<string, unknown>, verificationToken: Omit<Partial<databaseTypes.IVerificationToken>, '_id'>): Promise<databaseTypes.IVerificationToken>;
  updateVerificationTokenById(verificationTokenId: mongooseTypes.ObjectId, verificationToken: Omit<Partial<databaseTypes.IVerificationToken>, '_id'>): Promise<databaseTypes.IVerificationToken>;
