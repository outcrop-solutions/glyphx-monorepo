...
export interface IUserAgentStaticMethods
  ...
  updateUserAgentWithFilter(filter: Record<string, unknown>, userAgent: Omit<Partial<databaseTypes.IUserAgent>, '_id'>): Promise<databaseTypes.IUserAgent>;
  updateUserAgentById(userAgentId: mongooseTypes.ObjectId, userAgent: Omit<Partial<databaseTypes.IUserAgent>, '_id'>): Promise<databaseTypes.IUserAgent>;
