...
export interface IActivityLogStaticMethods
  ...
  updateActivityLogWithFilter(filter: Record<string, unknown>, activityLog: Omit<Partial<databaseTypes.IActivityLog>, '_id'>): Promise<databaseTypes.IActivityLog>;
  updateActivityLogById(activityLogId: mongooseTypes.ObjectId, activityLog: Omit<Partial<databaseTypes.IActivityLog>, '_id'>): Promise<databaseTypes.IActivityLog>;
