...
export interface IProcessTrackingStaticMethods
  ...
  updateProcessTrackingWithFilter(filter: Record<string, unknown>, processTracking: Omit<Partial<databaseTypes.IProcessTracking>, '_id'>): Promise<databaseTypes.IProcessTracking>;
  updateProcessTrackingById(processTrackingId: mongooseTypes.ObjectId, processTracking: Omit<Partial<databaseTypes.IProcessTracking>, '_id'>): Promise<databaseTypes.IProcessTracking>;
