...
export interface ITagStaticMethods
  ...
  queryTags(filter?: Record<string, unknown>, page?: number, itemsPerPage?: number): Promise<IQueryResult<databaseTypes.ITag>>;
  updateTagWithFilter(filter: Record<string, unknown>, tag: Omit<Partial<databaseTypes.ITag>, '_id'>): Promise<databaseTypes.ITag>;
  updateTagById(tagId: mongooseTypes.ObjectId, tag: Omit<Partial<databaseTypes.ITag>, '_id'>): Promise<databaseTypes.ITag>;
