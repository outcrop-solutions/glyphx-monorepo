...
export interface IModelConfigStaticMethods
  ...
  queryModelConfigs(filter?: Record<string, unknown>, page?: number, itemsPerPage?: number): Promise<IQueryResult<databaseTypes.IModelConfig>>;
  updateModelConfigWithFilter(filter: Record<string, unknown>, modelConfig: Omit<Partial<databaseTypes.IModelConfig>, '_id'>): Promise<databaseTypes.IModelConfig>;
  updateModelConfigById(modelConfigId: mongooseTypes.ObjectId, modelConfig: Omit<Partial<databaseTypes.IModelConfig>, '_id'>): Promise<databaseTypes.IModelConfig>;
