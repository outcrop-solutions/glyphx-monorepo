...
describe('#integrationTests/config', () => {
  ...
  before(async () => {
    ...
    configActions = proxyquire('../config', {
  ...
  context('#createConfig', () => {
    it('should create a new project', async () => {
      try {
        ...
        await configActions.createConfig(name, workspaceId, description, docId);
      } catch (error) {
        assert.fail();
      }
    });
    it('should throw an ActionError when provided invalid inputs', async () => {
      try {
        await configActions.createConfig(undefined);
      } catch (error) {
  ...
  context('#getConfigs', () => {
    it('should create a new project', async () => {
      try {
        ...
        await configActions.getConfigs(name, workspaceId, description, docId);
      } catch (error) {
        assert.fail();
      }
    });
    it('should throw an ActionError when provided invalid inputs', async () => {
      try {
        await configActions.getConfigs(undefined);
      } catch (error) {
        assert.instanceOf(error, ActionError);
      }
    });
  ...
  context('#getConfig', () => {
    it('should create a new project', async () => {
      try {
        ...
        await configActions.getConfig(name, workspaceId, description, docId);
      } catch (error) {
        assert.fail();
      }
    });
    it('should throw an ActionError when provided invalid inputs', async () => {
      try {
        await configActions.getConfig(undefined);
      } catch (error) {
        assert.instanceOf(error, ActionError);
      }
    });
  ...
  context('#updateConfig', () => {
    it('should create a new project', async () => {
      try {
        ...
        await configActions.updateConfig(name, workspaceId, description, docId);
      } catch (error) {
        assert.fail();
      }
    });
    it('should throw an ActionError when provided invalid inputs', async () => {
      try {
        await configActions.updateConfig(undefined);
      } catch (error) {
        assert.instanceOf(error, ActionError);
      }
    });
  ...
  context('#deleteConfig', () => {
    it('should create a new project', async () => {
      try {
        ...
        await configActions.deleteConfig(name, workspaceId, description, docId);
      } catch (error) {
        assert.fail();
      }
    });
    it('should throw an ActionError when provided invalid inputs', async () => {
      try {
        await configActions.deleteConfig(undefined);
      } catch (error) {
        assert.instanceOf(error, ActionError);
      }
    });
