...
export const ProjectSidebar = ({
  ...
  return (
    <div
      id="sidebar"
      ref={sidebar}
      className={`flex grow flex-col bg-secondary-space-blue absolute z-30 left-0 top-0 lg:static border-r border-l  border-gray lg:left-auto lg:top-auto  h-full w-full scrollbar-none`}
    >
