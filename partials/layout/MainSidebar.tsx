        ...
        <div className=" mt-1">
          {/* Pages group */}
            ...
            <ul className="mt-3 space-y-2">
              {/* Dashboard */}
              <li
                className={`rounded-full mb-0.5 last:mb-0`}
              >
                <div
                  className={`block text-gray hover:text-white truncate transition duration-150 bg-secondary-midnight`}
                >
                  <div
                    className={
                      selectedProject
                        ? "flex rounded pr-5 pt-1 pb-1 border border-transparent hover:border-white hover:cursor-pointer"
                        : "flex border border-white rounded pr-4 pt-1 pb-1 hover:cursor-pointer"
                    }
                  >
                    <div className="flex items-center justify-center h-6 w-6">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_3181_13896)">
                          <path d="M11.992 4C7.576 4 4 7.584 4 12C4 16.416 7.576 20 11.992 20C16.416 20 20 16.416 20 12C20 7.584 16.416 4 11.992 4ZM12 18.4C8.464 18.4 5.6 15.536 5.6 12C5.6 8.464 8.464 5.6 12 5.6C15.536 5.6 18.4 8.464 18.4 12C18.4 15.536 15.536 18.4 12 18.4ZM11.824 8H11.776C11.456 8 11.2 8.256 11.2 8.576V12.352C11.2 12.632 11.344 12.896 11.592 13.04L14.912 15.032C15.184 15.192 15.536 15.112 15.696 14.84C15.864 14.568 15.776 14.208 15.496 14.048L12.4 12.208V8.576C12.4 8.256 12.144 8 11.824 8Z" fill="#FFF" />
                        </g>
                        <defs>
              ...
              {/* Drafts */}
              <li
                className={`group rounded-sm mb-0.5 last:mb-0 `}
              >
                <div
                  className={`hover:cursor-pointer pr-4 pt-1 pb-1 group-hover:bg-secondary-midnight border border-transparent rounded group-hover:border-white block text-gray truncate transition duration-150`}
                >
                  <div className="flex">
                    <div className="flex items-center justify-center h-6 w-6">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13.5 4H7.5C6.675 4 6.0075 4.675 6.0075 5.5L6 17.5C6 18.325 6.6675 19 7.4925 19H16.5C17.325 19 18 18.325 18 17.5V8.5L13.5 4ZM7.5 17.5V5.5H12.75V9.25H16.5V17.5H7.5Z" fill="#CECECE" />
                      </svg>
