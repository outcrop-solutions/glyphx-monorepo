  ...
  return (
    ...
    <div className="sticky flex justify-between items-center bg-secondary-midnight  h-14 w-full pt-2 pb-2 px-4">
      <div className="flex items-center group border border-transparent pr-2 ml-6 bg-transparent">
        <div className="text-left flex flex-row items-center space-x-1">
          ...
          <p className="font-rubik font-normal text-white text-[22px] leading-[26px] tracking-[0.01em]">Recents</p>
        </div>
      ...
      <div className="flex flex-row space-x-3 pr-2">
        ...
        <button
          className={`h-8 p-1 flex items-center justify-center bg-transparent border border-transparent hover:border-white transition duration-150 rounded`}
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
