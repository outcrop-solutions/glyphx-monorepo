        ...
        <div className="flex items-center justify-between h-16 -mb-px">
          ...
          {!selectedProject && (
            <form
              ...
              className="relative bg-slate-400 bg-opacity-5 rounded-md hover:border-slate-300 hover:text-slate-600 z-60"
            >
              ...
              >
                <svg
                  className="w-4 h-4 shrink-0 fill-current text-white group-hover:text-slate-500 ml-3 mr-2"
                  viewBox="0 0 16 16"
