...
export const AddProjectModal = () => {
  ...
  return (
    <div className="absolute w-full h-full flex justify-center items-center bg-gray bg-opacity-50 z-60">
      <ClickAwayListener onClickAway={handleClickAway}>
        <div className="rounded-lg w-[928px] h-[506px] bg-gray z-60">
          <div className=" bg-primary-dark-blue mx-auto flex flex-col justify-center rounded-lg overflow-hidden shadow-xl transform transition-all">
              ...
              <aside className="py-4 px-2 sm:px-6 rounded-tl-lg  lg:col-span-3 bg-secondary-dark-blue">
                <nav className="space-y-1">
                  ...
                  <div
                    ...
                    className={`cursor-pointer text-white hover:text-white hover:bg-gray group px-3 py-1 flex rounded-full items-center text-sm font-bold ${current === 0 ? "bg-gray" : ""
                      }`}
                  >
                    <PlusIcon
                      ...
                      aria-hidden="true"
                    />
                    <span className="text-xs truncate">Create Project</span>
                  </div>
                  <div
                    onClick={() => setCurrent(2)}
                    className={`text-white hover:text-white hover:bg-gray group px-3 py-1 flex rounded-full items-center text-sm font-bold ${current === 2 ? "bg-gray" : ""
                      }`}
                  >
                    <UploadIcon
                  ...
                  <div
                    ...
                    className={`cursor-pointer text-white hover:text-white hover:bg-gray group px-3 py-1 flex rounded-full items-center text-sm font-bold ${current === 1 ? "bg-gray" : ""
                      }`}
                  >
                    <BookOpenIcon
                    ...
                    <div className="py-6 mb-4 px-4 space-y-6 sm:p-2">
                      ...
                      <div className="grid grid-cols-3 gap-6">
                        ...
                        >
                          <label
                            htmlFor="street-address"
                            className="block text-lg font-thin text-white mb-2"
                          >
