  ...
  return (
    ...
    >
      ...
      <div className="flex ml-3">
        <div className="flex items-center justify-center border-2 border-transparent hover:border-white p-1 rounded-full hover:cursor-pointer">
          <p className="text-xs text-white">
            LIN
          </p>
        </div>
        <div className="flex items-center justify-center border-2 border-transparent hover:border-white rounded-full p-1">
