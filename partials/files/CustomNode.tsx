...
export const CustomNode = ({
  ...
  return (
    <div
      ...
      className={`tree-node ${
        selectedFile === node.text ? "bg-gray" : ""
      } ${styles.root}`}
    ...
    >
      ...
      <div className="mr-2">
        ...
        <svg width="10" height="12" viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M6.25 0H1.25C0.5625 0 0.00625014 0.54 0.00625014 1.2L0 10.8C0 11.46 0.55625 12 1.24375 12H8.75C9.4375 12 10 11.46 10 10.8V3.6L6.25 0ZM1.25 10.8V1.2H5.625V4.2H8.75V10.8H1.25Z" fill="#CECECE"/>
        </svg>
