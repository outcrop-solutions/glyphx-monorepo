...
export function DraggableHeaderRenderer({
  ...
  function renderColumnTitle() {
    switch (assignedAxis) {
      case 'X':
        return <span className="inline-flex align-baseline">
          {column.name}
          <svg width="16" height="16" viewBox="0 0 16 16" fill="black" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" clipRule="evenodd" d="M8.99978 10.75C8.58557 10.75 8.24978 10.4142 8.24978 10V4.5C8.24978 4.08579 8.58557 3.75 8.99978 3.75C9.41399 3.75 9.74978 4.08579 9.74978 4.5V10C9.74978 10.4142 9.41399 10.75 8.99978 10.75Z" fill="black" />
            <path fillRule="evenodd" clipRule="evenodd" d="M3.8413 13.371C3.6157 13.0236 3.71443 12.5591 4.06182 12.3335L8.67451 9.338C9.0219 9.1124 9.4864 9.21113 9.71199 9.55852C9.93759 9.90591 9.83886 10.3704 9.49147 10.596L4.87878 13.5915C4.53139 13.8171 4.0669 13.7184 3.8413 13.371Z" fill="black" />
            <path fillRule="evenodd" clipRule="evenodd" d="M14.3413 13.379C14.1157 13.7264 13.6512 13.8251 13.3038 13.5995L8.69113 10.604C8.34374 10.3784 8.24501 9.91392 8.47061 9.56653C8.6962 9.21914 9.1607 9.12041 9.50809 9.34601L14.1208 12.3415C14.4682 12.5671 14.5669 13.0316 14.3413 13.379Z" fill="black" />
            <path d="M2.92 8.072C2.76 8.072 2.62667 8.02933 2.52 7.944C2.41867 7.85333 2.36 7.744 2.344 7.616C2.328 7.48267 2.37067 7.34667 2.472 7.208L4.24 4.864V5.416L2.544 3.16C2.44267 3.016 2.39733 2.88 2.408 2.752C2.424 2.61867 2.48267 2.50933 2.584 2.424C2.69067 2.33333 2.82133 2.288 2.976 2.288C3.10933 2.288 3.224 2.32 3.32 2.384C3.42133 2.448 3.52267 2.54933 3.624 2.688L4.944 4.512H4.544L5.856 2.688C5.95733 2.544 6.05867 2.44267 6.16 2.384C6.26133 2.32 6.37867 2.288 6.512 2.288C6.672 2.288 6.80267 2.33067 6.904 2.416C7.01067 2.50133 7.06933 2.61067 7.08 2.744C7.096 2.872 7.05067 3.01067 6.944 3.16L5.24 5.416V4.864L7 7.208C7.10667 7.34667 7.152 7.48267 7.136 7.616C7.12533 7.744 7.06667 7.85333 6.96 7.944C6.85867 8.02933 6.72533 8.072 6.56 8.072C6.432 8.072 6.31733 8.04 6.216 7.976C6.12 7.912 6.01867 7.808 5.912 7.664L4.536 5.768H4.944L3.568 7.664C3.46667 7.808 3.36533 7.912 3.264 7.976C3.16267 8.04 3.048 8.072 2.92 8.072Z" fill="black" />
          </svg> 
        </span>
