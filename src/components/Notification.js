	...
	const typeIcon = (type) => {
		switch (type) {
			case 'warning':
				return (
					<svg
						className='w-4 h-4 flex-shrink-0 fill-current text-yellow-500 mt-[3px] mr-3'
						viewBox='0 0 16 16'>
			...
			case 'error':
				return (
					<svg
						className='w-4 h-4 flex-shrink-0 fill-current text-red-500 mt-[3px] mr-3'
						viewBox='0 0 16 16'>
			...
			case 'success':
				return (
					<svg
						className='w-4 h-4 flex-shrink-0 fill-current text-green-500 mt-[3px] mr-3'
						viewBox='0 0 16 16'>
