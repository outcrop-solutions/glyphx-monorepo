      ...
      >
        <div ref={modalContent} className="z-60 bg-white overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg">
          ...
          <div className="py-4 px-2">
              ...
              <ul className="text-sm">
                ...
                <li>
                  ...
                  >
                    ...
                    <span>Filter #4 - manufacturing QA</span>
                  </Link>
                </li>
                <li>
                  <Link
            ...
            {/* Recent pages */}
            <div className="mb-3 last:mb-0">
              <div className="text-xs font-semibold text-gray-400 uppercase px-2 mb-2">Recent Projects</div>
              <ul className="text-sm">
                <li>
                  <Link
                    className="flex items-center p-2 text-gray-800 hover:text-white hover:bg-indigo-500 rounded group"
                  ...
                  >
                    ...
                    <span><span className="font-medium text-gray-800 group-hover:text-white">Project #1</span> - Filter#1 / … / Comments</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span><span className="font-medium text-gray-800 group-hover:text-white">Project #2</span> - FIlter #2 / … / Comments</span>
                  </Link>
                </li>
              </ul>
            </div>
