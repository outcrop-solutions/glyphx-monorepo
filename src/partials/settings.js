    ...
    <main className="flex-1 flex bg-primary-dark-blue overflow-hidden">
      <div className="flex-1 flex flex-col overflow-y-auto xl:overflow-hidden">
        ...
        <nav
          ...
          className=" border-b border-blue-gray-800 xl:hidden"
        >
              ...
              {subNavigation.map((item) => (
                <a
                  ...
                  className={classNames(
                    ...
                    "flex p-6 border-b border-blue-gray-800"
                  )}
                ...
                <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <input
                      ...
                      className="mt-1 block w-full border-blue-gray-300 rounded-md shadow-sm text-white sm:text-sm focus:ring-blue-500 focus:border-blue-500"
                    />
                  </div>
                  ...
                  <div className="sm:col-span-6">
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        className="flex-1 block w-full min-w-0 border-blue-gray-300 rounded-none rounded-r-md text-white sm:text-sm focus:ring-blue-500 focus:border-blue-500"
                      />
                    </div>
                  </div>
                  ...
                  <div className="sm:col-span-6">
                    ...
                    <div className="mt-1 flex items-center">
                      ...
                      <div className="ml-4 flex">
                        ...
                        <button
                          type="button"
                          className="ml-3 bg-transparent py-2 px-3 border border-transparent rounded-md text-sm font-medium text-white hover:text-blue-gray-700 focus:outline-none focus:border-blue-gray-300 focus:ring-2 focus:ring-offset-2 focus:ring-offset-blue-gray-50 focus:ring-blue-500"
                        >
                          Remove
                        </button>
                      </div>
