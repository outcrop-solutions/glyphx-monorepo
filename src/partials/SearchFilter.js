  ...
  return (
    ...
    >
      <div className="flex overflow-x-auto scrollbar-none">
        {chips.map((item, idx) => (
          <span className="px-2 py-1 rounded-full text-gray-500 border border-gray-300 font-semibold text-xs flex align-center cursor-pointer active:bg-gray-300 transition duration-300 ease">
            {item}
