      ...
      <div className="relative md:flex">
        ...
        <div className="w-full">
          <div className="max-w-sm mx-auto min-h-screen flex flex-col justify-center px-4 py-8">
            {isCodeSent ? (
              <div className="w-full rounded-md p-8 bg-slate-800">
                ...
                <div>
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        value={code}
                        onChange={handleCode}
                        className="form-input w-full bg-primary-dark-blue focus:bg-primary-dark-blue border-slate-400 focus:border-0"
                        type="number"
                      />
                    </div>
                    <div>
                  ...
                  <div className="flex justify-between mt-6">
                    ...
                    <button
                      ...
                      className="btn bg-yellow-400 hover:bg-yellow-600 text-slate-900 text-sm font-bold whitespace-nowrap rounded-2xl py-1 "
                    >
                      Submit
                    </button>
                  </div>
